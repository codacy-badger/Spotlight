    ...
    function drawCurve() {        
        curve.points([quad.start.attrs.x, quad.start.attrs.y, quad.control.attrs.x, 50, quad.end.attrs.x, quad.end.attrs.y]);
        curveLayer.draw();
    ...
    quad = {
        ...
        control: buildAnchor(draggablePadding, 50, 8),
